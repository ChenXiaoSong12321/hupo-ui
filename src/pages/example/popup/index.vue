  ...
  <demo-page title="Popup 弹出层">
    <demo-block title="基本用法" padding>
      ...
      <h-popup-base :show="show.basic" @onclose="hideBasic">
        <view class="h-demo-popup-item" style="width: 200px; height: 200px;">内容</view>
      </h-popup-base>
    </demo-block>
      ...
      <demo-row>
        <view class="h-demo-popup-item">
          ...
          <h-popup-base :show="show.top" position="top" @onclose="hideTop">
            <view class="h-demo-popup-item" style="width: 100%; height: 200px;">顶部弹出</view>
          </h-popup-base>
        </view>
        <view class="h-demo-popup-item">
      ...
      <demo-row>
        <view class="h-demo-popup-item">
          ...
          <h-popup-base :show="show.mask" @onclose="hideMask">
            <view class="h-demo-popup-item" style="width: 200px; height: 200px;">默认半透明</view>
          </h-popup-base>
        </view>
        <view class="h-demo-popup-item">
